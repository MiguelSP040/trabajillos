...
public class OwnerService {
    ...
    public ResponseEntity<?> findById(long id) {
        Map<String, Object> body = new HashMap<>();
        Owner found = ownerRepository.findById(id);
    ...
    public ResponseEntity<?> save (Owner owner){
        ...
        try {
            saved = ownerRepository.save(owner);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    @Transactional(rollbackFor = {SQLException.class, Exception.class})
    public ResponseEntity<?> update (Owner owner, Long id){
        Map<String, Object> body = new HashMap<>();
        Owner updated = null;
        ...
        if (ownerRepository.findById(id) != null) {
            owner.setId(id);
            try {
                updated = ownerRepository.save(owner);
            } catch (Exception e) {
                e.printStackTrace();
                System.out.println(e.getMessage());
            }
